    ...
    <div class="pt-4 bg-white shadow rounded">
      ...
      <div class="p-4 overflow-x-auto">
        <table class="table-auto w-full">
          <thead>
            <tr class="text-xs text-gray-500 text-left"><th class="pb-3 font-medium">SL</th><th class="pb-3 font-medium">Skill Name</th><th class="pb-3 font-medium">Image</th><th class="pb-3 font-medium">Status</th></tr>
          </thead>
          <tbody>
            <tr class="text-xs bg-gray-50" v-for="skill in skills.data" :key="skill.id">
              <td class="py-5 px-6 font-medium">{{  skill.id }}</td>
              <td class="font-medium">{{ skill.name  }}</td>
              <td class="font-medium">
                <img :src="skill.image" class="w-12 h-12 rounded-none" />
              </td>
              <td>
